...
abstract class RedisConnectionConfiguration {
    ...
    protected RedisConnectionConfiguration(RedisProperties properties) {
        ...
        this.standaloneConfiguration =this.getStandaloneConfig();
        this.sentinelConfiguration = this.getSentinelConfig();
        this.clusterConfiguration = this.getClusterConfiguration();
    }
